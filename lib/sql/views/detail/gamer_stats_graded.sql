...
SELECT
        ...
        COUNT(CASE WHEN gm.team_type = 'solo'
       ...
       COUNT(CASE WHEN gm.team_type = 'duo'
       ...
       COUNT(CASE WHEN gm.team_type = 'duo'
        ...
        COUNT(CASE WHEN gm.team_type = 'trio'
       ...
       COUNT(CASE WHEN gm.team_type = 'trio'
        ...
        COUNT(CASE WHEN gm.team_type = 'quad'
    ...
    FROM mapped gm
        JOIN warzone.grading_table gt ON gt.game_category = gm.game_category
 GROUP BY gm.uno_id, gm.game_category