     ...
     a AS (
         SELECT no.game_category,
                ...
                ARRAY [
                    ...
                    ROW ('average_lobby_skill_score', 12, no.average_lobby_skill_score, o.average_lobby_skill_score, no.average_lobby_skill_score / NULLIF(o.average_lobby_skill_score, 0), no.average_lobby_skill_score, o2.average_lobby_skill_score, no.average_lobby_skill_score / NULLIF(o2.average_lobby_skill_score, 0), FALSE),
                    ROW ('average_duo_lobby_skill_score', 13, no.average_duo_lobby_skill_score, o.average_duo_lobby_skill_score, no.average_duo_lobby_skill_score / NULLIF(o.average_duo_lobby_skill_score, 0), no.average_duo_lobby_skill_score, o2.average_duo_lobby_skill_score, no.average_duo_lobby_skill_score / NULLIF(o2.average_duo_lobby_skill_score, 0), FALSE),
                    ROW ('average_trio_lobby_skill_score', 14, no.average_trio_lobby_skill_score, o.average_trio_lobby_skill_score, no.average_trio_lobby_skill_score / NULLIF(o.average_trio_lobby_skill_score, 0), no.average_trio_lobby_skill_score, o2.average_trio_lobby_skill_score, no.average_trio_lobby_skill_score / NULLIF(o2.average_trio_lobby_skill_score, 0), FALSE),
                    ROW ('average_quad_lobby_skill_score', 15, no.average_quad_lobby_skill_score, o.average_quad_lobby_skill_score, no.average_lobby_skill_score / NULLIF(o.average_quad_lobby_skill_score, 0), no.average_quad_lobby_skill_score, o2.average_quad_lobby_skill_score, no.average_quad_lobby_skill_score / NULLIF(o2.average_quad_lobby_skill_score, 0), FALSE)
